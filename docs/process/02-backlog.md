...
|---|---|---|---|---|
| B-001 | Scaffold Astro 5 + Tailwind v4 + fonts | 0 | todo | Match docs/03 layout |
| B-002 | Design tokens in global.css `@theme` | 0 | todo | Exact hex from docs/02 |
| B-003 | Base + Page layouts, Navbar, Footer | 0 | todo | |
